        ...
        <a-row>
          ...
          <a-col :span="24">
            ...
            <a-form-item :label="fields.start_time.label" name="start_time">
              <a-date-picker v-model:value="form.start_time" :placeholder="fields.start_time.placeholder"/>
            </a-form-item>

            <a-form-item :label="fields.end_time.label" name="end_time">
              <a-date-picker v-model:value="form.end_time" :placeholder="fields.end_time.placeholder"/>
            </a-form-item>
          </a-col>
        </a-row>
      </a-col>
