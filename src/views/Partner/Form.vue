<template>
  ...
  >
    <a-row>
      ...
      <a-col :span="12">
        <a-row>
          <a-col class="info">{{$t('partner.title.general_information')}}</a-col>
          <a-col :span="24">
        ...
        <a-row>
          ...
          <a-col :span="24">
            ...
            <a-form-item :label="fields.name_of_province_id.label" name="province">
              <o-select
                ref="province"
                :value="form.province"
            ...
            <a-form-item :label="fields.name_of_district_id.label" name="district">
              <o-select
                ref="district"
                :value="form.district"
...
const onChangeRoleDelete = ($event) => {
     // formUser.role_ids = formUser.role_ids.filter((p) => p != $event);
};
